...
# 路径请根据实际情况修改
petri_path = "/home/shenxz-lab/code/ChainCollab/Experiment/petri-stateCharts/colored_PetriNet/result.txt"
statecharts_path = "/home/shenxz-lab/code/ChainCollab/Experiment/petri-stateCharts/stateCharts/result.txt"

N_list_petri, mean_invoke_petri = parse_result_file(petri_path)
N_list_state, mean_invoke_state = parse_result_file(statecharts_path)
...
plt.savefig("compare_color_statecharts.png")
plt.show()