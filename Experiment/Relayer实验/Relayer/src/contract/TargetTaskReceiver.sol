...
contract TargetTaskReceiver {
    ...
    bytes32 private constant RELAY_DOMAIN = keccak256("RELAY_EXECUTION_V1");
    ...
    function relayTask(
        ...
        emit TaskDelivered(taskId, payloadHash, msg.sender, sourceChainId, sourceContract);
    }
