...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateMessage(ctx, &instance, "Message_045i10y", "Participant_1080bkg", "Participant_0sktaei", "", DISABLED, `{"schema": "{\"properties\":{\"serviceId\":{\"type\":\"string\",\"description\":\"The required service id\"}},\"required\":[\"serviceId\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0m9p3da", "Participant_1080bkg", "Participant_0sktaei", "", DISABLED, `{"schema": "{\"properties\":{\"invoice\":{\"type\":\"boolean\",\"description\":\"Do you need an invoice?\"}},\"required\":[\"invoice\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0o8eyir", "Participant_1080bkg", "Participant_0sktaei", "", DISABLED, `{"schema": "{\"properties\":{\"payment amount\":{\"type\":\"number\",\"description\":\"payment amount\"},\"orderID\":{\"type\":\"number\",\"description\":\"The order id of payment\"},\"temperature\":{\"type\":\"number\",\"description\":\"The decision of temperature\"},\"dataType\":{\"type\":\"string\",\"description\":\"The decision of datatype(eh: Wednesday..)\"}},\"required\":[\"payment amount\",\"orderID\",\"temperature\",\"dataType\"],\"files\":{},\"file required\":[]}"}`)
...
func (cc *SmartContract) ExclusiveGateway_0nzwv7v(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	} else if instance.InstanceStateMemory.Invoice == true {
...
func (cc *SmartContract) Gateway_1bhtapl(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.SetInstance(ctx, instance)
	if instance.InstanceStateMemory.Need_external_provider == true {
