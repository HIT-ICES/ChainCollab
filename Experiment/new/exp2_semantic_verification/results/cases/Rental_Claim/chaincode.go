...
type StateMemory struct {
	BondContent string `json:"BondContent"`
	FileContent string `json:"FileContent"`
	ClaimContent string `json:"ClaimContent"`
	Content string `json:"Content"`
	DamageNumber int `json:"DamageNumber"`
	Reason string `json:"Reason"`
	Refund bool `json:"Refund"`
	Refundbond int `json:"Refundbond"`
	Transfer_date string `json:"Transfer_date"`
}

type InitParameters struct {
	Participant_1exbsak Participant `json:"Participant_1exbsak"`
	Participant_0h34s41 Participant `json:"Participant_0h34s41"`
	Participant_0wvo0aa Participant `json:"Participant_0wvo0aa"`
	Activity_0oacu9j_DecisionID string `json:"Activity_0oacu9j_DecisionID"`
	Activity_0oacu9j_ParamMapping map[string]string `json:"Activity_0oacu9j_ParamMapping"`
	Activity_0oacu9j_Content string `json:"Activity_0oacu9j_Content"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "Participant_1exbsak", initParameters.Participant_1exbsak.MSP, initParameters.Participant_1exbsak.Attributes, initParameters.Participant_1exbsak.X509, initParameters.Participant_1exbsak.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "Participant_0h34s41", initParameters.Participant_0h34s41.MSP, initParameters.Participant_0h34s41.Attributes, initParameters.Participant_0h34s41.X509, initParameters.Participant_0h34s41.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "Participant_0wvo0aa", initParameters.Participant_0wvo0aa.MSP, initParameters.Participant_0wvo0aa.Attributes, initParameters.Participant_0wvo0aa.X509, initParameters.Participant_0wvo0aa.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "Event_19zgkxm", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "Event_1pjpbaw", DISABLED)
	cc.CreateActionEvent(ctx, &instance, "Event_120hui7", DISABLED)
	cc.CreateActionEvent(ctx, &instance, "Event_0fzlrii", DISABLED)
	cc.CreateActionEvent(ctx, &instance, "Event_0kmeww3", DISABLED)
	cc.CreateMessage(ctx, &instance, "Message_066q5si", "Participant_0h34s41", "Participant_0wvo0aa", "", DISABLED, `{"schema": "{\"properties\":{\"reason\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[\"reason\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_09eyqv0", "Participant_1exbsak", "Participant_0h34s41", "", DISABLED, `{"schema": "{\"properties\":{\"FileContent\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0dckgao", "Participant_1exbsak", "Participant_0h34s41", "", DISABLED, `{"schema": "{\"properties\":{\"BondContent\":{\"type\":\"string\",\"description\":\"\"},\"damageNumber\":{\"type\":\"number\",\"description\":\"\"}},\"required\":[\"BondContent\",\"damageNumber\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0fm3vfa", "Participant_0h34s41", "Participant_1exbsak", "", DISABLED, `{"schema": "{\"properties\":{\"transfer date\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[\"transfer date\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0zoy0sz", "Participant_0h34s41", "Participant_0wvo0aa", "", DISABLED, `{"schema": "{\"properties\":{\"refundbond\":{\"type\":\"number\",\"description\":\"\"}},\"required\":[\"refundbond\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1eb4q8q", "Participant_0h34s41", "Participant_0wvo0aa", "", DISABLED, `{"schema": "{\"properties\":{\"claimContent\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1im6vvb", "Participant_0wvo0aa", "Participant_0h34s41", "", DISABLED, `{"schema": "{\"properties\":{\"content\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1xlzl3n", "Participant_0h34s41", "Participant_1exbsak", "", DISABLED, `{"schema": "{\"properties\":{\"reason\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[\"reason\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateGateway(ctx, &instance, "Gateway_11zw5fs", DISABLED)
	cc.CreateGateway(ctx, &instance, "Gateway_10ut9pb", DISABLED)
	cc.CreateGateway(ctx, &instance, "Gateway_1v1x25n", DISABLED)
	cc.CreateBusinessRule(ctx, &instance, "Activity_0oacu9j", initParameters.Activity_0oacu9j_Content, initParameters.Activity_0oacu9j_DecisionID, initParameters.Activity_0oacu9j_ParamMapping)
	...
	eventPayload := map[string]string{
		"InstanceID": instanceID,
		"Activity_0oacu9j": initParameters.Activity_0oacu9j_Content,
	}
...
func (cc *SmartContract) Activity_0oacu9j(ctx contractapi.TransactionContextInterface, instanceID string) error {


	instance, err := cc.GetInstance(ctx, instanceID)
	// Read Business Info
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "Activity_0oacu9j")
	if err != nil {
		return err
	}
	...
	eventPayload := map[string]string{
		"ID":        "Activity_0oacu9j",
		"InstanceID": instanceID,
		"Func":	   "Activity_0oacu9j_Continue",
		"CID": dataItem.Value, 
	}
	...
	cc.ChangeBusinessRuleState(ctx, instance, "Activity_0oacu9j", WAITINGFORCONFIRMATION)
	cc.SetInstance(ctx, instance)

	return nil
}

func (cc *SmartContract) Activity_0oacu9j_Continue(ctx contractapi.TransactionContextInterface, instanceID string, ContentOfDmn string) error {
	// Read Business Info
	instance,err:=cc.GetInstance(ctx, instanceID)
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "Activity_0oacu9j")
	if err != nil {
	...
	cc.ChangeBusinessRuleState(ctx, instance, "Activity_0oacu9j", COMPLETED)

	cc.ChangeGtwState(ctx, instance, "Gateway_11zw5fs", ENABLED)


	cc.SetInstance(ctx, instance)
	eventPayload := map[string]string{
		"ID":         "Activity_0oacu9j_Continue",
		"InstanceID": instanceID,
	}
...
func (cc *SmartContract) Event_19zgkxm(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)

	actionEvent, err := cc.ReadEvent(ctx, instanceID, "Event_19zgkxm")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "Event_19zgkxm", COMPLETED)
	stub.SetEvent("Event_19zgkxm", []byte("Contract has been started successfully"))
	cc.SetInstance(ctx, instance)
	cc.ChangeGtwState(ctx, instance, "Gateway_10ut9pb", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_066q5si_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_066q5si")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgState(ctx, instance, "Message_066q5si", COMPLETED)

	stub.SetEvent("Message_066q5si", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_066q5si_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_066q5si")
	if err != nil {
	...
	stub.SetEvent("Message_066q5si", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_09eyqv0_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_09eyqv0")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_09eyqv0", COMPLETED)

	stub.SetEvent("Message_09eyqv0", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_09eyqv0_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_09eyqv0")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_09eyqv0", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_0dckgao", DISABLED)
	cc.ChangeMsgState(ctx, instance, "Message_1eb4q8q", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_0dckgao_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_0dckgao")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_0dckgao", COMPLETED)

	stub.SetEvent("Message_0dckgao", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_0dckgao_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_0dckgao")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_0dckgao", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_09eyqv0", DISABLED)
	cc.ChangeBusinessRuleState(ctx, instance, "Activity_0oacu9j", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_0fm3vfa_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_0fm3vfa")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_0fm3vfa", COMPLETED)

	stub.SetEvent("Message_0fm3vfa", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_0fm3vfa_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_0fm3vfa")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_0fm3vfa", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeEventState(ctx, instance, "Event_120hui7", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_0zoy0sz_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_0zoy0sz")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_0zoy0sz", COMPLETED)

	stub.SetEvent("Message_0zoy0sz", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_0zoy0sz_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_0zoy0sz")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_0zoy0sz", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeEventState(ctx, instance, "Event_0fzlrii", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_1eb4q8q_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1eb4q8q")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_1eb4q8q", COMPLETED)

	stub.SetEvent("Message_1eb4q8q", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_1eb4q8q_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1eb4q8q")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_1eb4q8q", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeGtwState(ctx, instance, "Gateway_1v1x25n", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_1im6vvb_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1im6vvb")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_1im6vvb", COMPLETED)

	stub.SetEvent("Message_1im6vvb", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_1im6vvb_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1im6vvb")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_1im6vvb", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_0fm3vfa", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_1xlzl3n_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1xlzl3n")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_1xlzl3n", COMPLETED)

	stub.SetEvent("Message_1xlzl3n", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_1xlzl3n_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1xlzl3n")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_1xlzl3n", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeEventState(ctx, instance, "Event_1pjpbaw", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Gateway_11zw5fs(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "Gateway_11zw5fs")
	if err != nil {
		return err
	}
	...
	stub.SetEvent("Gateway_11zw5fs", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	if instance.InstanceStateMemory.Refund == true {
		cc.ChangeMsgState(ctx, instance, "Message_0zoy0sz", ENABLED)
	} else if instance.InstanceStateMemory.Refund == false {
		cc.ChangeEventState(ctx, instance, "Event_0kmeww3", ENABLED)
	}
...
func (cc *SmartContract) Gateway_10ut9pb(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "Gateway_10ut9pb")
	if err != nil {
		return err
	}
	...
	cc.ChangeGtwState(ctx, instance, gtw.GatewayID, COMPLETED)
	stub.SetEvent("Gateway_10ut9pb", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_09eyqv0", ENABLED)
	cc.ChangeMsgState(ctx, instance, "Message_0dckgao", ENABLED)
...
func (cc *SmartContract) Gateway_1v1x25n(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "Gateway_1v1x25n")
	if err != nil {
		return err
	}
	...
	cc.ChangeGtwState(ctx, instance, gtw.GatewayID, COMPLETED)
	stub.SetEvent("Gateway_1v1x25n", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_1im6vvb", ENABLED)
...
func (cc *SmartContract) Event_1pjpbaw(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "Event_1pjpbaw")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "Event_1pjpbaw", COMPLETED)
	stub.SetEvent("Event_1pjpbaw", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Event_120hui7(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "Event_120hui7")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "Event_120hui7", COMPLETED)
	stub.SetEvent("Event_120hui7", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Event_0fzlrii(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "Event_0fzlrii")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "Event_0fzlrii", COMPLETED)
	stub.SetEvent("Event_0fzlrii", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Event_0kmeww3(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "Event_0kmeww3")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "Event_0kmeww3", COMPLETED)
	stub.SetEvent("Event_0kmeww3", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
