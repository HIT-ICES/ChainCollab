...
type InitParameters struct {
	Participant_0ykkst0 Participant `json:"Participant_0ykkst0"`
	Participant_1be5jmm Participant `json:"Participant_1be5jmm"`
	Participant_0a0qr98 Participant `json:"Participant_0a0qr98"`
	Activity_18dcm0h_DecisionID string `json:"Activity_18dcm0h_DecisionID"`
	Activity_18dcm0h_ParamMapping map[string]string `json:"Activity_18dcm0h_ParamMapping"`
	Activity_18dcm0h_Content string `json:"Activity_18dcm0h_Content"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "Participant_0ykkst0", initParameters.Participant_0ykkst0.MSP, initParameters.Participant_0ykkst0.Attributes, initParameters.Participant_0ykkst0.X509, initParameters.Participant_0ykkst0.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "Participant_1be5jmm", initParameters.Participant_1be5jmm.MSP, initParameters.Participant_1be5jmm.Attributes, initParameters.Participant_1be5jmm.X509, initParameters.Participant_1be5jmm.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "Participant_0a0qr98", initParameters.Participant_0a0qr98.MSP, initParameters.Participant_0a0qr98.Attributes, initParameters.Participant_0a0qr98.X509, initParameters.Participant_0a0qr98.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "Event_1y0sgtz", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "Event_1u0cugu", DISABLED)
	cc.CreateActionEvent(ctx, &instance, "Event_1pm2yw6", DISABLED)
	cc.CreateMessage(ctx, &instance, "Message_02echpq", "Participant_0ykkst0", "Participant_1be5jmm", "", DISABLED, `{"schema": "{\"properties\":{\"content2\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_02ng01e", "Participant_1be5jmm", "Participant_0ykkst0", "", DISABLED, `{"schema": "{\"properties\":{\"complete\":{\"type\":\"boolean\",\"description\":\"\"}},\"required\":[\"complete\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_094ld7m", "Participant_0ykkst0", "Participant_1be5jmm", "", DISABLED, `{"schema": "{\"properties\":{\"quality\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[\"quality\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1ejkslm", "Participant_0a0qr98", "Participant_1be5jmm", "", DISABLED, `{"schema": "{\"properties\":{\"Content\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1h1vc49", "Participant_1be5jmm", "Participant_0ykkst0", "", DISABLED, `{"schema": "{\"properties\":{\"id\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[\"id\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1tiyc35", "Participant_0ykkst0", "Participant_1be5jmm", "", DISABLED, `{"schema": "{\"properties\":{\"content3\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateGateway(ctx, &instance, "Gateway_067p6u8", DISABLED)
	cc.CreateGateway(ctx, &instance, "Gateway_1fl1t0k", DISABLED)
	cc.CreateGateway(ctx, &instance, "Gateway_0e7k79c", DISABLED)
	cc.CreateBusinessRule(ctx, &instance, "Activity_18dcm0h", initParameters.Activity_18dcm0h_Content, initParameters.Activity_18dcm0h_DecisionID, initParameters.Activity_18dcm0h_ParamMapping)
	...
	eventPayload := map[string]string{
		"InstanceID": instanceID,
		"Activity_18dcm0h": initParameters.Activity_18dcm0h_Content,
	}
...
func (cc *SmartContract) Activity_18dcm0h(ctx contractapi.TransactionContextInterface, instanceID string) error {


	instance, err := cc.GetInstance(ctx, instanceID)
	// Read Business Info
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "Activity_18dcm0h")
	if err != nil {
		return err
	}
	...
	eventPayload := map[string]string{
		"ID":        "Activity_18dcm0h",
		"InstanceID": instanceID,
		"Func":	   "Activity_18dcm0h_Continue",
		"CID": dataItem.Value, 
	}
	...
	cc.ChangeBusinessRuleState(ctx, instance, "Activity_18dcm0h", WAITINGFORCONFIRMATION)
	cc.SetInstance(ctx, instance)

	return nil
}

func (cc *SmartContract) Activity_18dcm0h_Continue(ctx contractapi.TransactionContextInterface, instanceID string, ContentOfDmn string) error {
	// Read Business Info
	instance,err:=cc.GetInstance(ctx, instanceID)
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "Activity_18dcm0h")
	if err != nil {
	...
	cc.ChangeBusinessRuleState(ctx, instance, "Activity_18dcm0h", COMPLETED)

	cc.ChangeGtwState(ctx, instance, "Gateway_1fl1t0k", ENABLED)


	cc.SetInstance(ctx, instance)
	eventPayload := map[string]string{
		"ID":         "Activity_18dcm0h_Continue",
		"InstanceID": instanceID,
	}
...
func (cc *SmartContract) Event_1y0sgtz(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)

	actionEvent, err := cc.ReadEvent(ctx, instanceID, "Event_1y0sgtz")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "Event_1y0sgtz", COMPLETED)
	stub.SetEvent("Event_1y0sgtz", []byte("Contract has been started successfully"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_1ejkslm", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_02echpq_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_02echpq")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgState(ctx, instance, "Message_02echpq", COMPLETED)

	stub.SetEvent("Message_02echpq", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_02echpq_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_02echpq")
	if err != nil {
	...
	stub.SetEvent("Message_02echpq", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_1tiyc35", DISABLED)
	cc.ChangeGtwState(ctx, instance, "Gateway_067p6u8", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_02ng01e_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_02ng01e")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_02ng01e", COMPLETED)

	stub.SetEvent("Message_02ng01e", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_02ng01e_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_02ng01e")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_02ng01e", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_094ld7m", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_094ld7m_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_094ld7m")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_094ld7m", COMPLETED)

	stub.SetEvent("Message_094ld7m", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_094ld7m_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_094ld7m")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_094ld7m", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeBusinessRuleState(ctx, instance, "Activity_18dcm0h", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_1ejkslm_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1ejkslm")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_1ejkslm", COMPLETED)

	stub.SetEvent("Message_1ejkslm", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_1ejkslm_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1ejkslm")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_1ejkslm", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeGtwState(ctx, instance, "Gateway_0e7k79c", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_1h1vc49_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1h1vc49")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_1h1vc49", COMPLETED)

	stub.SetEvent("Message_1h1vc49", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_1h1vc49_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1h1vc49")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_1h1vc49", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeEventState(ctx, instance, "Event_1pm2yw6", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_1tiyc35_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1tiyc35")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_1tiyc35", COMPLETED)

	stub.SetEvent("Message_1tiyc35", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_1tiyc35_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1tiyc35")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_1tiyc35", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_02echpq", DISABLED)
	cc.ChangeGtwState(ctx, instance, "Gateway_067p6u8", ENABLED)
...
func (cc *SmartContract) Gateway_067p6u8(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "Gateway_067p6u8")
	if err != nil {
		return err
	}
	...
	stub.SetEvent("Gateway_067p6u8", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_02ng01e", ENABLED)
...
func (cc *SmartContract) Gateway_1fl1t0k(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "Gateway_1fl1t0k")
	if err != nil {
		return err
	}
	...
	cc.ChangeGtwState(ctx, instance, gtw.GatewayID, COMPLETED)
	stub.SetEvent("Gateway_1fl1t0k", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	if instance.InstanceStateMemory.Qualified == true {
		cc.ChangeEventState(ctx, instance, "Event_1u0cugu", ENABLED)
	} else if instance.InstanceStateMemory.Qualified == false {
		cc.ChangeMsgState(ctx, instance, "Message_1h1vc49", ENABLED)
	}
...
func (cc *SmartContract) Gateway_0e7k79c(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "Gateway_0e7k79c")
	if err != nil {
		return err
	}
	...
	cc.ChangeGtwState(ctx, instance, gtw.GatewayID, COMPLETED)
	stub.SetEvent("Gateway_0e7k79c", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_02echpq", ENABLED)
	cc.ChangeMsgState(ctx, instance, "Message_1tiyc35", ENABLED)
...
func (cc *SmartContract) Event_1u0cugu(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "Event_1u0cugu")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "Event_1u0cugu", COMPLETED)
	stub.SetEvent("Event_1u0cugu", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Event_1pm2yw6(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "Event_1pm2yw6")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "Event_1pm2yw6", COMPLETED)
	stub.SetEvent("Event_1pm2yw6", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
