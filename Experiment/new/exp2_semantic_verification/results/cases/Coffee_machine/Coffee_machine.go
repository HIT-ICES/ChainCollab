...
type InitParameters struct {
	...
	Activity_0ysk2q6_DecisionID string `json:"Activity_0ysk2q6_DecisionID"`
	Activity_0ysk2q6_ParamMapping map[string]string `json:"Activity_0ysk2q6_ParamMapping"`
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "Participant_1pasf6v", initParameters.Participant_1pasf6v.MSP, initParameters.Participant_1pasf6v.Attributes, initParameters.Participant_1pasf6v.X509, initParameters.Participant_1pasf6v.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "Participant_1tddbk5", initParameters.Participant_1tddbk5.MSP, initParameters.Participant_1tddbk5.Attributes, initParameters.Participant_1tddbk5.X509, initParameters.Participant_1tddbk5.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "StartEvent_1v2ab61", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "EndEvent_17h95ah", DISABLED)
	cc.CreateMessage(ctx, &instance, "Message_0gg08bf", "Participant_1tddbk5", "Participant_1pasf6v", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0i0xp6a", "Participant_1pasf6v", "Participant_1tddbk5", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1e90tfn", "Participant_1pasf6v", "Participant_1tddbk5", "", DISABLED, `{"schema": "{\"properties\":{\"error\":{\"type\":\"boolean\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1j4s0qh", "Participant_1tddbk5", "Participant_1pasf6v", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1uiozoi", "Participant_1tddbk5", "Participant_1pasf6v", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateGateway(ctx, &instance, "ExclusiveGateway_0c8hy9b", DISABLED)
	cc.CreateGateway(ctx, &instance, "ExclusiveGateway_1sp1v7s", DISABLED)
	cc.CreateBusinessRule(ctx, &instance, "Activity_0ysk2q6", initParameters.Activity_0ysk2q6_Content, initParameters.Activity_0ysk2q6_DecisionID, initParameters.Activity_0ysk2q6_ParamMapping)
	...
	eventPayload := map[string]string{
		"InstanceID": instanceID,
		"Activity_0ysk2q6": initParameters.Activity_0ysk2q6_Content,
	}
...
func (cc *SmartContract) Activity_0ysk2q6(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.ChangeBusinessRuleState(ctx, instance, "Activity_0ysk2q6", WAITINGFORCONFIRMATION)
...
func (cc *SmartContract) Activity_0ysk2q6_Continue(ctx contractapi.TransactionContextInterface, instanceID string, ContentOfDmn string) error {
	...
	cc.ChangeBusinessRuleState(ctx, instance, "Activity_0ysk2q6", COMPLETED)

	cc.ChangeMsgState(ctx, instance, "Message_1e90tfn", ENABLED)


	cc.SetInstance(ctx, instance)
	eventPayload := map[string]string{
		"ID":         "Activity_0ysk2q6_Continue",
		"InstanceID": instanceID,
	}
...
func (cc *SmartContract) StartEvent_1v2ab61(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.ChangeEventState(ctx, instance, "StartEvent_1v2ab61", COMPLETED)
	stub.SetEvent("StartEvent_1v2ab61", []byte("Contract has been started successfully"))
	cc.SetInstance(ctx, instance)
	cc.ChangeGtwState(ctx, instance, "ExclusiveGateway_1sp1v7s", ENABLED)
...
func (cc *SmartContract) Message_0gg08bf_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	...
	cc.ChangeMsgState(ctx, instance, "Message_0gg08bf", COMPLETED)
...
func (cc *SmartContract) Message_0gg08bf_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_1j4s0qh", ENABLED)
...
func (cc *SmartContract) Message_0i0xp6a_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_0i0xp6a", COMPLETED)
...
func (cc *SmartContract) Message_0i0xp6a_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_0gg08bf", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_1e90tfn_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_1e90tfn", COMPLETED)
...
func (cc *SmartContract) Message_1e90tfn_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_1uiozoi", ENABLED)
...
func (cc *SmartContract) Message_1j4s0qh_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_1j4s0qh", COMPLETED)
...
func (cc *SmartContract) Message_1j4s0qh_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.SetInstance(ctx, instance)
	cc.ChangeGtwState(ctx, instance, "ExclusiveGateway_0c8hy9b", ENABLED)
...
func (cc *SmartContract) Message_1uiozoi_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_1uiozoi", COMPLETED)
...
func (cc *SmartContract) Message_1uiozoi_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_0i0xp6a", ENABLED)
...
func (cc *SmartContract) ExclusiveGateway_0c8hy9b(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	stub.SetEvent("ExclusiveGateway_0c8hy9b", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	if instance.InstanceStateMemory.Error == true {
		cc.ChangeGtwState(ctx, instance, "ExclusiveGateway_1sp1v7s", ENABLED)
	} else if instance.InstanceStateMemory.Error == false {
		cc.ChangeEventState(ctx, instance, "EndEvent_17h95ah", ENABLED)
	}
...
func (cc *SmartContract) ExclusiveGateway_1sp1v7s(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.ChangeGtwState(ctx, instance, gtw.GatewayID, COMPLETED)
	stub.SetEvent("ExclusiveGateway_1sp1v7s", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	cc.ChangeBusinessRuleState(ctx, instance, "Activity_0ysk2q6", ENABLED)
...
func (cc *SmartContract) EndEvent_17h95ah(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "EndEvent_17h95ah")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "EndEvent_17h95ah", COMPLETED)
	stub.SetEvent("EndEvent_17h95ah", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
