...
type StateMemory struct {
	...
	ConcelAck string `json:"ConcelAck"`
	Fee string `json:"Fee"`
	...
	PayRecord string `json:"PayRecord"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateMessage(ctx, &instance, "Message_00wpjke", "Participant_1xq1vsc", "Participant_05g5xih", "", DISABLED, `{"schema": "{\"properties\":{\"QuoteRequest\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[\"QuoteRequest\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_03was4c", "Participant_1xq1vsc", "Participant_05g5xih", "", DISABLED, `{"schema": "{\"properties\":{\"confirm message\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[\"confirm message\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_05uqcn2", "Participant_1xq1vsc", "Participant_05g5xih", "", DISABLED, `{"schema": "{\"properties\":{\"payMethod\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0z8kf0j", "Participant_1xq1vsc", "Participant_05g5xih", "", DISABLED, `{"schema": "{\"properties\":{\"cancelation\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[\"cancelation\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0zt8q9t", "Participant_05g5xih", "Participant_1xq1vsc", "", DISABLED, `{"schema": "{\"properties\":{\"ConcelAck\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[\"ConcelAck\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_13l7271", "Participant_1xq1vsc", "Participant_05g5xih", "", DISABLED, `{"schema": "{\"properties\":{\"payRecord\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1i5n14f", "Participant_05g5xih", "Participant_1xq1vsc", "", DISABLED, `{"schema": "{\"properties\":{\"Fee\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1kazup6", "Participant_05g5xih", "Participant_1xq1vsc", "", DISABLED, `{"schema": "{\"properties\":{\"QuoteContent\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[\"QuoteContent\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1y5d31x", "Participant_05g5xih", "Participant_1xq1vsc", "", DISABLED, `{"schema": "{\"properties\":{\"OrderContent\":{\"type\":\"string\",\"description\":\"\"},\"OrderAmount\":{\"type\":\"number\",\"description\":\"\"}},\"required\":[\"OrderContent\",\"OrderAmount\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1yln43l", "Participant_05g5xih", "Participant_1xq1vsc", "", DISABLED, `{"schema": "{\"properties\":{\"InvoiceContent\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
...
func (cc *SmartContract) Message_00wpjke_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_00wpjke")
	if err != nil {
	...
	stub.SetEvent("Message_00wpjke", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Message_03was4c_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_03was4c")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_03was4c", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Message_05uqcn2_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_05uqcn2")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_05uqcn2", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Message_0z8kf0j_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_0z8kf0j")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_0z8kf0j", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Message_0zt8q9t_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_0zt8q9t")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_0zt8q9t", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Message_13l7271_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_13l7271")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_13l7271", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Message_1i5n14f_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1i5n14f")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_1i5n14f", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Message_1kazup6_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1kazup6")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_1kazup6", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Message_1y5d31x_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
...
func (cc *SmartContract) Message_1y5d31x_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1y5d31x")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_1y5d31x", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Message_1yln43l_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1yln43l")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_1yln43l", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Gateway_19zzj3s(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	stub.SetEvent("Gateway_19zzj3s", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	if instance.InstanceStateMemory.CancelFee == false {
		cc.ChangeEventState(ctx, instance, "Event_0awuo5v", ENABLED)
	} else if instance.InstanceStateMemory.CancelFee == true {
...
func (cc *SmartContract) Gateway_085e7pr(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.ChangeGtwState(ctx, instance, gtw.GatewayID, COMPLETED)
	stub.SetEvent("Gateway_085e7pr", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Event_0th6os0(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "Event_0th6os0")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "Event_0th6os0", COMPLETED)
	stub.SetEvent("Event_0th6os0", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
...
func (cc *SmartContract) Event_0awuo5v(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "Event_0awuo5v")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "Event_0awuo5v", COMPLETED)
	stub.SetEvent("Event_0awuo5v", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
...
func (cc *SmartContract) Event_0zsq5na(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "Event_0zsq5na")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "Event_0zsq5na", COMPLETED)
	stub.SetEvent("Event_0zsq5na", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
