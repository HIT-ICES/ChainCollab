...
type StateMemory struct {
	...
	DeliveryInfomation string `json:"DeliveryInfomation"`
	OrderContent string `json:"OrderContent"`
	PickUpTime string `json:"PickUpTime"`
	Signature string `json:"Signature"`
	BikePrepare bool `json:"BikePrepare"`
	CarPrepare bool `json:"CarPrepare"`
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateMessage(ctx, &instance, "Message_0gm7yco", "Participant_1f296fx", "Participant_1ssz56y", "", DISABLED, `{"schema": "{\"properties\":{\"PickUpTime\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[\"PickUpTime\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0nc7bj9", "Participant_1f296fx", "Participant_1ssz56y", "", DISABLED, `{"schema": "{\"properties\":{\"bikePrepare\":{\"type\":\"boolean\",\"description\":\"\"}},\"required\":[\"bikePrepare\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0phlgzx", "Participant_1f296fx", "Participant_0szm9kv", "", DISABLED, `{"schema": "{\"properties\":{\"DeliveryInfomation\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_10c1p7j", "Participant_1ssz56y", "Participant_1f296fx", "", DISABLED, `{"schema": "{\"properties\":{\"Address\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[\"Address\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1hi03zn", "Participant_1ssz56y", "Participant_0szm9kv", "", DISABLED, `{"schema": "{\"properties\":{\"Signature\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[\"Signature\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1kyybzd", "Participant_1f296fx", "Participant_1ssz56y", "", DISABLED, `{"schema": "{\"properties\":{\"carPrepare\":{\"type\":\"boolean\",\"description\":\"\"}},\"required\":[\"carPrepare\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1l76ppu", "Participant_1f296fx", "Participant_1ssz56y", "", DISABLED, `{"schema": "{\"properties\":{\"Signature\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1wwub0e", "Participant_1ssz56y", "Participant_1f296fx", "", DISABLED, `{"schema": "{\"properties\":{\"OrderContent\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[\"OrderContent\"],\"files\":{},\"file required\":[]}"}`)
...
func (cc *SmartContract) Message_0gm7yco_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_0gm7yco")
	if err != nil {
	...
	stub.SetEvent("Message_0gm7yco", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Message_0nc7bj9_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_0nc7bj9")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_0nc7bj9", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Message_0phlgzx_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_0phlgzx")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_0phlgzx", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Message_10c1p7j_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
...
func (cc *SmartContract) Message_10c1p7j_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_10c1p7j")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_10c1p7j", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Message_1hi03zn_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1hi03zn")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_1hi03zn", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Message_1kyybzd_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1kyybzd")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_1kyybzd", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeGtwState(ctx, instance, "Gateway_18xv5wc", ENABLED)
...
func (cc *SmartContract) Message_1l76ppu_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1l76ppu")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_1l76ppu", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeGtwState(ctx, instance, "Gateway_1rwnujh", ENABLED)
...
func (cc *SmartContract) Message_1wwub0e_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_1wwub0e")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_1wwub0e", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Gateway_0ckb278(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	stub.SetEvent("Gateway_0ckb278", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	if instance.InstanceStateMemory.Distance >= 10 {
		cc.ChangeMsgState(ctx, instance, "Message_0nc7bj9", ENABLED)
	} else if instance.InstanceStateMemory.Distance < 10 {
...
func (cc *SmartContract) Gateway_18xv5wc(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.ChangeGtwState(ctx, instance, gtw.GatewayID, COMPLETED)
	stub.SetEvent("Gateway_18xv5wc", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Gateway_1rwnujh(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.ChangeGtwState(ctx, instance, gtw.GatewayID, COMPLETED)
	stub.SetEvent("Gateway_1rwnujh", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Gateway_1k9qf30(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.ChangeGtwState(ctx, instance, gtw.GatewayID, COMPLETED)
	stub.SetEvent("Gateway_1k9qf30", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Event_1bxai2s(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "Event_1bxai2s")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "Event_1bxai2s", COMPLETED)
	stub.SetEvent("Event_1bxai2s", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
