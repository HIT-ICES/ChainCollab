...
type InitParameters struct {
	A Participant `json:"A"`
	B Participant `json:"B"`
	C Participant `json:"C"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "A", initParameters.A.MSP, initParameters.A.Attributes, initParameters.A.X509, initParameters.A.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "B", initParameters.B.MSP, initParameters.B.Attributes, initParameters.B.X509, initParameters.B.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "C", initParameters.C.MSP, initParameters.C.Attributes, initParameters.C.X509, initParameters.C.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "StartEvent_1", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "EndEvent_1", DISABLED)
	cc.CreateMessage(ctx, &instance, "MsgA", "A", "B", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "MsgB", "B", "C", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "MsgC", "C", "A", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateGateway(ctx, &instance, "ParallelGateway_1", DISABLED)
	cc.CreateGateway(ctx, &instance, "ParallelGateway_2", DISABLED)
...
func (cc *SmartContract) StartEvent_1(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)

	actionEvent, err := cc.ReadEvent(ctx, instanceID, "StartEvent_1")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "StartEvent_1", COMPLETED)
	stub.SetEvent("StartEvent_1", []byte("Contract has been started successfully"))
	cc.SetInstance(ctx, instance)
	cc.ChangeGtwState(ctx, instance, "ParallelGateway_1", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MsgA_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MsgA")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgState(ctx, instance, "MsgA", COMPLETED)

	stub.SetEvent("MsgA", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MsgA_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MsgA")
	if err != nil {
	...
	stub.SetEvent("MsgA", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeGtwState(ctx, instance, "ParallelGateway_2", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MsgB_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MsgB")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "MsgB", COMPLETED)

	stub.SetEvent("MsgB", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MsgB_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MsgB")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("MsgB", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeGtwState(ctx, instance, "ParallelGateway_2", ENABLED)
...
func (cc *SmartContract) MsgC_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MsgC")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "MsgC", COMPLETED)

	stub.SetEvent("MsgC", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MsgC_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MsgC")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("MsgC", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeEventState(ctx, instance, "EndEvent_1", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) ParallelGateway_1(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "ParallelGateway_1")
	if err != nil {
		return err
	}
	...
	stub.SetEvent("ParallelGateway_1", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "MsgA", ENABLED)
	cc.ChangeMsgState(ctx, instance, "MsgB", ENABLED)
...
func (cc *SmartContract) ParallelGateway_2(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "ParallelGateway_2")
	if err != nil {
		return err
	}
	...
	if !(instance.InstanceMessages["MsgA"].MsgState == COMPLETED && instance.InstanceMessages["MsgB"].MsgState == COMPLETED) {
		return fmt.Errorf("Parallel gateway prerequisite not met")
	}


	cc.ChangeGtwState(ctx, instance, gtw.GatewayID, COMPLETED)
	stub.SetEvent("ParallelGateway_2", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "MsgC", ENABLED)
...
func (cc *SmartContract) EndEvent_1(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "EndEvent_1")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "EndEvent_1", COMPLETED)
	stub.SetEvent("EndEvent_1", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
