...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "Buyer", initParameters.Buyer.MSP, initParameters.Buyer.Attributes, initParameters.Buyer.X509, initParameters.Buyer.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "Seller", initParameters.Seller.MSP, initParameters.Seller.Attributes, initParameters.Seller.X509, initParameters.Seller.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "StartEvent_1", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "EndEvent_1", DISABLED)
	cc.CreateMessage(ctx, &instance, "Offer", "Seller", "Buyer", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "Cancel", "Buyer", "Seller", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "Accept", "Buyer", "Seller", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateGateway(ctx, &instance, "Decide", DISABLED)
...
func (cc *SmartContract) StartEvent_1(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.ChangeMsgState(ctx, instance, "Offer", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Offer_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Offer")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgState(ctx, instance, "Offer", COMPLETED)

	stub.SetEvent("Offer", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Offer_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Offer")
	if err != nil {
	...
	stub.SetEvent("Offer", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
globalMemory,readGloabolError := cc.ReadGlobalVariable(ctx, instanceID)
	...
	cc.ChangeGtwState(ctx, instance, "Decide", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Cancel_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Cancel")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Cancel", COMPLETED)

	stub.SetEvent("Cancel", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Cancel_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Cancel")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Cancel", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Accept", DISABLED)
...
func (cc *SmartContract) Accept_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Accept")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Accept", COMPLETED)

	stub.SetEvent("Accept", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Accept_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Accept")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Accept", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeEventState(ctx, instance, "EndEvent_1", ENABLED)
...
func (cc *SmartContract) Decide(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "Decide")
	if err != nil {
		return err
	}
	...
	stub.SetEvent("Decide", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	if instance.InstanceStateMemory.Retry == true {
		cc.ChangeMsgState(ctx, instance, "Cancel", ENABLED)
	} else {
		cc.ChangeMsgState(ctx, instance, "Accept", ENABLED)
	}
