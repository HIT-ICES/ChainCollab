...
type StateMemory struct {
	FlagB bool `json:"FlagB"`
}

type InitParameters struct {
	P1B Participant `json:"P1B"`
	P2B Participant `json:"P2B"`
	P3B Participant `json:"P3B"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "P1B", initParameters.P1B.MSP, initParameters.P1B.Attributes, initParameters.P1B.X509, initParameters.P1B.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "P2B", initParameters.P2B.MSP, initParameters.P2B.Attributes, initParameters.P2B.X509, initParameters.P2B.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "P3B", initParameters.P3B.MSP, initParameters.P3B.Attributes, initParameters.P3B.X509, initParameters.P3B.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "StartEvent_MB", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "EndEvent_MB", DISABLED)
	cc.CreateMessage(ctx, &instance, "MB1", "P1B", "P2B", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "MB2", "P2B", "P3B", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "MB3", "P3B", "P1B", "", DISABLED, `{"schema": "{}"}`)
...
func (cc *SmartContract) StartEvent_MB(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)

	actionEvent, err := cc.ReadEvent(ctx, instanceID, "StartEvent_MB")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "StartEvent_MB", COMPLETED)
	stub.SetEvent("StartEvent_MB", []byte("Contract has been started successfully"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "MB1", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MB1_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MB1")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgState(ctx, instance, "MB1", COMPLETED)

	stub.SetEvent("MB1", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MB1_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MB1")
	if err != nil {
	...
	stub.SetEvent("MB1", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "MB2", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MB2_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MB2")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "MB2", COMPLETED)

	stub.SetEvent("MB2", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MB2_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MB2")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("MB2", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "MB3", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MB3_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MB3")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "MB3", COMPLETED)

	stub.SetEvent("MB3", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MB3_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MB3")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("MB3", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeEventState(ctx, instance, "EndEvent_MB", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) EndEvent_MB(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "EndEvent_MB")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "EndEvent_MB", COMPLETED)
	stub.SetEvent("EndEvent_MB", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
