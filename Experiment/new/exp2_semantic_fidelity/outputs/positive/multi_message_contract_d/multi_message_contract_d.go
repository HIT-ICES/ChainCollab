...
type InitParameters struct {
	D1 Participant `json:"D1"`
	D2 Participant `json:"D2"`
	D3 Participant `json:"D3"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "D1", initParameters.D1.MSP, initParameters.D1.Attributes, initParameters.D1.X509, initParameters.D1.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "D2", initParameters.D2.MSP, initParameters.D2.Attributes, initParameters.D2.X509, initParameters.D2.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "D3", initParameters.D3.MSP, initParameters.D3.Attributes, initParameters.D3.X509, initParameters.D3.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "StartEvent_MD", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "EndEvent_MD", DISABLED)
	cc.CreateMessage(ctx, &instance, "MD1", "D1", "D2", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "MD2", "D2", "D3", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "MD3", "D3", "D1", "", DISABLED, `{"schema": "{}"}`)
...
func (cc *SmartContract) StartEvent_MD(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)

	actionEvent, err := cc.ReadEvent(ctx, instanceID, "StartEvent_MD")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "StartEvent_MD", COMPLETED)
	stub.SetEvent("StartEvent_MD", []byte("Contract has been started successfully"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "MD1", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MD1_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MD1")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgState(ctx, instance, "MD1", COMPLETED)

	stub.SetEvent("MD1", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MD1_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MD1")
	if err != nil {
	...
	stub.SetEvent("MD1", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "MD2", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MD2_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MD2")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "MD2", COMPLETED)

	stub.SetEvent("MD2", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MD2_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MD2")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("MD2", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "MD3", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MD3_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MD3")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "MD3", COMPLETED)

	stub.SetEvent("MD3", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MD3_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MD3")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("MD3", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeEventState(ctx, instance, "EndEvent_MD", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) EndEvent_MD(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "EndEvent_MD")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "EndEvent_MD", COMPLETED)
	stub.SetEvent("EndEvent_MD", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
