...
type StateMemory struct {
	AmountD int `json:"AmountD"`
	GrantD bool `json:"GrantD"`
}

type InitParameters struct {
	OfficeD Participant `json:"OfficeD"`
	StaffD Participant `json:"StaffD"`
	RuleD_DecisionID string `json:"RuleD_DecisionID"`
	RuleD_ParamMapping map[string]string `json:"RuleD_ParamMapping"`
	RuleD_Content string `json:"RuleD_Content"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "OfficeD", initParameters.OfficeD.MSP, initParameters.OfficeD.Attributes, initParameters.OfficeD.X509, initParameters.OfficeD.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "StaffD", initParameters.StaffD.MSP, initParameters.StaffD.Attributes, initParameters.StaffD.X509, initParameters.StaffD.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "StartEvent_BRD", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "EndEvent_BRD", DISABLED)
	cc.CreateMessage(ctx, &instance, "ApplyD", "StaffD", "OfficeD", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "ReplyD", "OfficeD", "StaffD", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateGateway(ctx, &instance, "ChoiceD", DISABLED)
	cc.CreateBusinessRule(ctx, &instance, "RuleD", initParameters.RuleD_Content, initParameters.RuleD_DecisionID, initParameters.RuleD_ParamMapping)
	...
	eventPayload := map[string]string{
		"InstanceID": instanceID,
		"RuleD": initParameters.RuleD_Content,
	}
...
func (cc *SmartContract) RuleD(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.ChangeBusinessRuleState(ctx, instance, "RuleD", WAITINGFORCONFIRMATION)
	cc.SetInstance(ctx, instance)

	return nil
}

func (cc *SmartContract) RuleD_Continue(ctx contractapi.TransactionContextInterface, instanceID string, ContentOfDmn string) error {
	// Read Business Info
	instance,err:=cc.GetInstance(ctx, instanceID)
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "RuleD")
	if err != nil {
...
func (cc *SmartContract) StartEvent_BRD(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
...
func (cc *SmartContract) ApplyD_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
...
func (cc *SmartContract) ApplyD_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "ApplyD")
	if err != nil {
...
func (cc *SmartContract) ReplyD_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
...
func (cc *SmartContract) ReplyD_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "ReplyD")
	if err != nil {
...
func (cc *SmartContract) ChoiceD(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
...
func (cc *SmartContract) EndEvent_BRD(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
