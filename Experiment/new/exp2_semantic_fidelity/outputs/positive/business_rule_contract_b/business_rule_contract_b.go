...
type StateMemory struct {
	...
	ApprovedB bool `json:"ApprovedB"`
}

type InitParameters struct {
	ClerkB Participant `json:"ClerkB"`
	ReviewerB Participant `json:"ReviewerB"`
	RuleB_DecisionID string `json:"RuleB_DecisionID"`
	RuleB_ParamMapping map[string]string `json:"RuleB_ParamMapping"`
	RuleB_Content string `json:"RuleB_Content"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "ClerkB", initParameters.ClerkB.MSP, initParameters.ClerkB.Attributes, initParameters.ClerkB.X509, initParameters.ClerkB.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "ReviewerB", initParameters.ReviewerB.MSP, initParameters.ReviewerB.Attributes, initParameters.ReviewerB.X509, initParameters.ReviewerB.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "StartEvent_BRB", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "EndEvent_BRB", DISABLED)
	cc.CreateMessage(ctx, &instance, "SubmitB", "ClerkB", "ReviewerB", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "ResultB", "ReviewerB", "ClerkB", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateGateway(ctx, &instance, "ReviewDecisionB", DISABLED)
	cc.CreateBusinessRule(ctx, &instance, "RuleB", initParameters.RuleB_Content, initParameters.RuleB_DecisionID, initParameters.RuleB_ParamMapping)
	...
	eventPayload := map[string]string{
		"InstanceID": instanceID,
		"RuleB": initParameters.RuleB_Content,
	}
...
func (cc *SmartContract) RuleB(ctx contractapi.TransactionContextInterface, instanceID string) error {


	instance, err := cc.GetInstance(ctx, instanceID)
	// Read Business Info
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "RuleB")
	if err != nil {
		return err
	}
	...
	cc.ChangeBusinessRuleState(ctx, instance, "RuleB", WAITINGFORCONFIRMATION)
	cc.SetInstance(ctx, instance)

	return nil
}

func (cc *SmartContract) RuleB_Continue(ctx contractapi.TransactionContextInterface, instanceID string, ContentOfDmn string) error {
	// Read Business Info
	instance,err:=cc.GetInstance(ctx, instanceID)
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "RuleB")
	if err != nil {
	...
	cc.ChangeBusinessRuleState(ctx, instance, "RuleB", COMPLETED)

	cc.ChangeGtwState(ctx, instance, "ReviewDecisionB", ENABLED)
...
func (cc *SmartContract) StartEvent_BRB(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)

	actionEvent, err := cc.ReadEvent(ctx, instanceID, "StartEvent_BRB")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "StartEvent_BRB", COMPLETED)
	stub.SetEvent("StartEvent_BRB", []byte("Contract has been started successfully"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "SubmitB", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) SubmitB_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "SubmitB")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgState(ctx, instance, "SubmitB", COMPLETED)

	stub.SetEvent("SubmitB", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) SubmitB_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "SubmitB")
	if err != nil {
	...
	stub.SetEvent("SubmitB", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeBusinessRuleState(ctx, instance, "RuleB", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) ResultB_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "ResultB")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "ResultB", COMPLETED)

	stub.SetEvent("ResultB", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) ResultB_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "ResultB")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("ResultB", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeEventState(ctx, instance, "EndEvent_BRB", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) ReviewDecisionB(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "ReviewDecisionB")
	if err != nil {
		return err
	}
	...
	stub.SetEvent("ReviewDecisionB", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	if instance.InstanceStateMemory.ApprovedB == true {
		cc.ChangeMsgState(ctx, instance, "ResultB", ENABLED)
	} else {
		cc.ChangeEventState(ctx, instance, "EndEvent_BRB", ENABLED)
	}
...
func (cc *SmartContract) EndEvent_BRB(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "EndEvent_BRB")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "EndEvent_BRB", COMPLETED)
	stub.SetEvent("EndEvent_BRB", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
