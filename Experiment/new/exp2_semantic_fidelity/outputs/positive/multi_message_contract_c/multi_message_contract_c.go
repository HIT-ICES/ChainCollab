...
type StateMemory struct {
	FlagC bool `json:"FlagC"`
}

type InitParameters struct {
	C1 Participant `json:"C1"`
	C2 Participant `json:"C2"`
	C3 Participant `json:"C3"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "C1", initParameters.C1.MSP, initParameters.C1.Attributes, initParameters.C1.X509, initParameters.C1.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "C2", initParameters.C2.MSP, initParameters.C2.Attributes, initParameters.C2.X509, initParameters.C2.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "C3", initParameters.C3.MSP, initParameters.C3.Attributes, initParameters.C3.X509, initParameters.C3.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "StartEvent_MC", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "EndEvent_MC", DISABLED)
	cc.CreateMessage(ctx, &instance, "MC1", "C1", "C2", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "MC2", "C2", "C3", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "MC3", "C3", "C1", "", DISABLED, `{"schema": "{}"}`)
...
func (cc *SmartContract) StartEvent_MC(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)

	actionEvent, err := cc.ReadEvent(ctx, instanceID, "StartEvent_MC")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "StartEvent_MC", COMPLETED)
	stub.SetEvent("StartEvent_MC", []byte("Contract has been started successfully"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "MC1", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MC1_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MC1")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgState(ctx, instance, "MC1", COMPLETED)

	stub.SetEvent("MC1", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MC1_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MC1")
	if err != nil {
	...
	stub.SetEvent("MC1", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "MC2", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MC2_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MC2")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "MC2", COMPLETED)

	stub.SetEvent("MC2", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MC2_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MC2")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("MC2", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "MC3", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MC3_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MC3")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "MC3", COMPLETED)

	stub.SetEvent("MC3", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MC3_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MC3")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("MC3", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeEventState(ctx, instance, "EndEvent_MC", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) EndEvent_MC(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "EndEvent_MC")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "EndEvent_MC", COMPLETED)
	stub.SetEvent("EndEvent_MC", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
