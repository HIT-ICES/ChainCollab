...
type InitParameters struct {
	Clerk Participant `json:"Clerk"`
	Reviewer Participant `json:"Reviewer"`
	RuleA_DecisionID string `json:"RuleA_DecisionID"`
	RuleA_ParamMapping map[string]string `json:"RuleA_ParamMapping"`
	RuleA_Content string `json:"RuleA_Content"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "Clerk", initParameters.Clerk.MSP, initParameters.Clerk.Attributes, initParameters.Clerk.X509, initParameters.Clerk.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "Reviewer", initParameters.Reviewer.MSP, initParameters.Reviewer.Attributes, initParameters.Reviewer.X509, initParameters.Reviewer.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "StartEvent_1", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "EndEvent_1", DISABLED)
	cc.CreateMessage(ctx, &instance, "Submit", "Clerk", "Reviewer", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "ResultMsg", "Reviewer", "Clerk", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateGateway(ctx, &instance, "ReviewDecision", DISABLED)
	cc.CreateBusinessRule(ctx, &instance, "RuleA", initParameters.RuleA_Content, initParameters.RuleA_DecisionID, initParameters.RuleA_ParamMapping)
	...
	eventPayload := map[string]string{
		"InstanceID": instanceID,
		"RuleA": initParameters.RuleA_Content,
	}
...
func (cc *SmartContract) RuleA(ctx contractapi.TransactionContextInterface, instanceID string) error {


	instance, err := cc.GetInstance(ctx, instanceID)
	// Read Business Info
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "RuleA")
	if err != nil {
		return err
	}
	...
	cc.ChangeBusinessRuleState(ctx, instance, "RuleA", WAITINGFORCONFIRMATION)
	cc.SetInstance(ctx, instance)

	return nil
}

func (cc *SmartContract) RuleA_Continue(ctx contractapi.TransactionContextInterface, instanceID string, ContentOfDmn string) error {
	// Read Business Info
	instance,err:=cc.GetInstance(ctx, instanceID)
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "RuleA")
	if err != nil {
	...
	cc.ChangeBusinessRuleState(ctx, instance, "RuleA", COMPLETED)

	cc.ChangeGtwState(ctx, instance, "ReviewDecision", ENABLED)
...
func (cc *SmartContract) StartEvent_1(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Submit", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Submit_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Submit")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgState(ctx, instance, "Submit", COMPLETED)

	stub.SetEvent("Submit", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Submit_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Submit")
	if err != nil {
	...
	stub.SetEvent("Submit", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeBusinessRuleState(ctx, instance, "RuleA", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) ResultMsg_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "ResultMsg")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "ResultMsg", COMPLETED)

	stub.SetEvent("ResultMsg", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) ResultMsg_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "ResultMsg")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("ResultMsg", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) ReviewDecision(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "ReviewDecision")
	if err != nil {
		return err
	}
	...
	stub.SetEvent("ReviewDecision", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	if instance.InstanceStateMemory.Approved == true {
		cc.ChangeMsgState(ctx, instance, "ResultMsg", ENABLED)
	} else {
		cc.ChangeEventState(ctx, instance, "EndEvent_1", ENABLED)
	}
