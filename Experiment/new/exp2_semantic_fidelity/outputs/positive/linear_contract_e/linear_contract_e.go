...
type StateMemory struct {
	ContinueE bool `json:"ContinueE"`
}

type InitParameters struct {
	OrgE1 Participant `json:"OrgE1"`
	OrgE2 Participant `json:"OrgE2"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "OrgE1", initParameters.OrgE1.MSP, initParameters.OrgE1.Attributes, initParameters.OrgE1.X509, initParameters.OrgE1.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "OrgE2", initParameters.OrgE2.MSP, initParameters.OrgE2.Attributes, initParameters.OrgE2.X509, initParameters.OrgE2.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "StartEvent_E", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "EndEvent_E", DISABLED)
	cc.CreateMessage(ctx, &instance, "MsgE1", "OrgE1", "OrgE2", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "MsgE2", "OrgE2", "OrgE1", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateGateway(ctx, &instance, "GateE", DISABLED)
...
func (cc *SmartContract) StartEvent_E(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)

	actionEvent, err := cc.ReadEvent(ctx, instanceID, "StartEvent_E")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "StartEvent_E", COMPLETED)
	stub.SetEvent("StartEvent_E", []byte("Contract has been started successfully"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "MsgE1", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MsgE1_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MsgE1")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgState(ctx, instance, "MsgE1", COMPLETED)

	stub.SetEvent("MsgE1", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MsgE1_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MsgE1")
	if err != nil {
	...
	stub.SetEvent("MsgE1", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeGtwState(ctx, instance, "GateE", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MsgE2_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MsgE2")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "MsgE2", COMPLETED)

	stub.SetEvent("MsgE2", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) MsgE2_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "MsgE2")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("MsgE2", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeEventState(ctx, instance, "EndEvent_E", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) GateE(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "GateE")
	if err != nil {
		return err
	}
	...
	stub.SetEvent("GateE", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	if instance.InstanceStateMemory.ContinueE == true {
		cc.ChangeMsgState(ctx, instance, "MsgE2", ENABLED)
	} else {
		cc.ChangeEventState(ctx, instance, "EndEvent_E", ENABLED)
	}
...
func (cc *SmartContract) EndEvent_E(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "EndEvent_E")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "EndEvent_E", COMPLETED)
	stub.SetEvent("EndEvent_E", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
