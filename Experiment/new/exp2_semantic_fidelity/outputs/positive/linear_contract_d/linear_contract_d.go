...
type StateMemory struct {
	DeliverD bool `json:"DeliverD"`
}

type InitParameters struct {
	LabD Participant `json:"LabD"`
	UserD Participant `json:"UserD"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "LabD", initParameters.LabD.MSP, initParameters.LabD.Attributes, initParameters.LabD.X509, initParameters.LabD.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "UserD", initParameters.UserD.MSP, initParameters.UserD.Attributes, initParameters.UserD.X509, initParameters.UserD.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "StartEvent_D", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "EndEvent_D", DISABLED)
	cc.CreateMessage(ctx, &instance, "SubmitD", "UserD", "LabD", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "ReturnD", "LabD", "UserD", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateGateway(ctx, &instance, "GateD", DISABLED)
...
func (cc *SmartContract) StartEvent_D(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)

	actionEvent, err := cc.ReadEvent(ctx, instanceID, "StartEvent_D")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "StartEvent_D", COMPLETED)
	stub.SetEvent("StartEvent_D", []byte("Contract has been started successfully"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "SubmitD", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) SubmitD_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "SubmitD")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgState(ctx, instance, "SubmitD", COMPLETED)

	stub.SetEvent("SubmitD", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) SubmitD_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "SubmitD")
	if err != nil {
	...
	stub.SetEvent("SubmitD", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeGtwState(ctx, instance, "GateD", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) ReturnD_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "ReturnD")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "ReturnD", COMPLETED)

	stub.SetEvent("ReturnD", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) ReturnD_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "ReturnD")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("ReturnD", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeEventState(ctx, instance, "EndEvent_D", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) GateD(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "GateD")
	if err != nil {
		return err
	}
	...
	stub.SetEvent("GateD", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	if instance.InstanceStateMemory.DeliverD == true {
		cc.ChangeMsgState(ctx, instance, "ReturnD", ENABLED)
	} else {
		cc.ChangeEventState(ctx, instance, "EndEvent_D", ENABLED)
	}
...
func (cc *SmartContract) EndEvent_D(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "EndEvent_D")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "EndEvent_D", COMPLETED)
	stub.SetEvent("EndEvent_D", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
