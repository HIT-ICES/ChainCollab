...
type StateMemory struct {
	InputC int `json:"InputC"`
	PassedC bool `json:"PassedC"`
}

type InitParameters struct {
	InitiatorC Participant `json:"InitiatorC"`
	AuditorC Participant `json:"AuditorC"`
	RuleC_DecisionID string `json:"RuleC_DecisionID"`
	RuleC_ParamMapping map[string]string `json:"RuleC_ParamMapping"`
	RuleC_Content string `json:"RuleC_Content"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "InitiatorC", initParameters.InitiatorC.MSP, initParameters.InitiatorC.Attributes, initParameters.InitiatorC.X509, initParameters.InitiatorC.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "AuditorC", initParameters.AuditorC.MSP, initParameters.AuditorC.Attributes, initParameters.AuditorC.X509, initParameters.AuditorC.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "StartEvent_BRC", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "EndEvent_BRC", DISABLED)
	cc.CreateMessage(ctx, &instance, "SendC", "InitiatorC", "AuditorC", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "NotifyC", "AuditorC", "InitiatorC", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateGateway(ctx, &instance, "ChoiceC", DISABLED)
	cc.CreateBusinessRule(ctx, &instance, "RuleC", initParameters.RuleC_Content, initParameters.RuleC_DecisionID, initParameters.RuleC_ParamMapping)
	...
	eventPayload := map[string]string{
		"InstanceID": instanceID,
		"RuleC": initParameters.RuleC_Content,
	}
...
func (cc *SmartContract) RuleC(ctx contractapi.TransactionContextInterface, instanceID string) error {


	instance, err := cc.GetInstance(ctx, instanceID)
	// Read Business Info
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "RuleC")
	if err != nil {
		return err
	}
	...
	cc.ChangeBusinessRuleState(ctx, instance, "RuleC", WAITINGFORCONFIRMATION)
	cc.SetInstance(ctx, instance)

	return nil
}

func (cc *SmartContract) RuleC_Continue(ctx contractapi.TransactionContextInterface, instanceID string, ContentOfDmn string) error {
	// Read Business Info
	instance,err:=cc.GetInstance(ctx, instanceID)
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "RuleC")
	if err != nil {
	...
	cc.ChangeBusinessRuleState(ctx, instance, "RuleC", COMPLETED)

	cc.ChangeGtwState(ctx, instance, "ChoiceC", ENABLED)
...
func (cc *SmartContract) StartEvent_BRC(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)

	actionEvent, err := cc.ReadEvent(ctx, instanceID, "StartEvent_BRC")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "StartEvent_BRC", COMPLETED)
	stub.SetEvent("StartEvent_BRC", []byte("Contract has been started successfully"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "SendC", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) SendC_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "SendC")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgState(ctx, instance, "SendC", COMPLETED)

	stub.SetEvent("SendC", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) SendC_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "SendC")
	if err != nil {
	...
	stub.SetEvent("SendC", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeBusinessRuleState(ctx, instance, "RuleC", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) NotifyC_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "NotifyC")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "NotifyC", COMPLETED)

	stub.SetEvent("NotifyC", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) NotifyC_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "NotifyC")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("NotifyC", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeEventState(ctx, instance, "EndEvent_BRC", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) ChoiceC(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "ChoiceC")
	if err != nil {
		return err
	}
	...
	stub.SetEvent("ChoiceC", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	if instance.InstanceStateMemory.PassedC == true {
		cc.ChangeMsgState(ctx, instance, "NotifyC", ENABLED)
	} else {
		cc.ChangeEventState(ctx, instance, "EndEvent_BRC", ENABLED)
	}
...
func (cc *SmartContract) EndEvent_BRC(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "EndEvent_BRC")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "EndEvent_BRC", COMPLETED)
	stub.SetEvent("EndEvent_BRC", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
