...
type InitParameters struct {
	P1 Participant `json:"P1"`
	P2 Participant `json:"P2"`
	P3 Participant `json:"P3"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "P1", initParameters.P1.MSP, initParameters.P1.Attributes, initParameters.P1.X509, initParameters.P1.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "P2", initParameters.P2.MSP, initParameters.P2.Attributes, initParameters.P2.X509, initParameters.P2.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "P3", initParameters.P3.MSP, initParameters.P3.Attributes, initParameters.P3.X509, initParameters.P3.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "StartEvent_1", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "EndEvent_1", DISABLED)
	cc.CreateMessage(ctx, &instance, "M1", "P1", "P2", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "M2", "P2", "P3", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "M3", "P3", "P1", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateGateway(ctx, &instance, "G1", DISABLED)
...
func (cc *SmartContract) StartEvent_1(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.ChangeMsgState(ctx, instance, "M1", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) M1_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "M1")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgState(ctx, instance, "M1", COMPLETED)

	stub.SetEvent("M1", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) M1_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "M1")
	if err != nil {
	...
	stub.SetEvent("M1", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "M2", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) M2_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "M2")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "M2", COMPLETED)

	stub.SetEvent("M2", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) M2_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "M2")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("M2", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "M3", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) M3_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "M3")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "M3", COMPLETED)

	stub.SetEvent("M3", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) M3_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "M3")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("M3", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) G1(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "G1")
	if err != nil {
		return err
	}
	...
	stub.SetEvent("G1", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
