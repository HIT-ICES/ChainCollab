...
type StateMemory struct {
	MetricE int `json:"MetricE"`
	OkE bool `json:"OkE"`
}

type InitParameters struct {
	TeamE Participant `json:"TeamE"`
	LeadE Participant `json:"LeadE"`
	RuleE_DecisionID string `json:"RuleE_DecisionID"`
	RuleE_ParamMapping map[string]string `json:"RuleE_ParamMapping"`
	RuleE_Content string `json:"RuleE_Content"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateParticipant(ctx, &instance, "TeamE", initParameters.TeamE.MSP, initParameters.TeamE.Attributes, initParameters.TeamE.X509, initParameters.TeamE.IsMulti, 0, 0)
	cc.CreateParticipant(ctx, &instance, "LeadE", initParameters.LeadE.MSP, initParameters.LeadE.Attributes, initParameters.LeadE.X509, initParameters.LeadE.IsMulti, 0, 0)
	cc.CreateActionEvent(ctx, &instance, "StartEvent_BRE", ENABLED)
	cc.CreateActionEvent(ctx, &instance, "EndEvent_BRE", DISABLED)
	cc.CreateMessage(ctx, &instance, "InputE", "TeamE", "LeadE", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateMessage(ctx, &instance, "OutputE", "LeadE", "TeamE", "", DISABLED, `{"schema": "{}"}`)
	cc.CreateGateway(ctx, &instance, "GateE2", DISABLED)
	cc.CreateBusinessRule(ctx, &instance, "RuleE", initParameters.RuleE_Content, initParameters.RuleE_DecisionID, initParameters.RuleE_ParamMapping)
	...
	eventPayload := map[string]string{
		"InstanceID": instanceID,
		"RuleE": initParameters.RuleE_Content,
	}
...
func (cc *SmartContract) RuleE(ctx contractapi.TransactionContextInterface, instanceID string) error {


	instance, err := cc.GetInstance(ctx, instanceID)
	// Read Business Info
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "RuleE")
	if err != nil {
		return err
	}
	...
	cc.ChangeBusinessRuleState(ctx, instance, "RuleE", WAITINGFORCONFIRMATION)
	cc.SetInstance(ctx, instance)

	return nil
}

func (cc *SmartContract) RuleE_Continue(ctx contractapi.TransactionContextInterface, instanceID string, ContentOfDmn string) error {
	// Read Business Info
	instance,err:=cc.GetInstance(ctx, instanceID)
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "RuleE")
	if err != nil {
	...
	cc.ChangeBusinessRuleState(ctx, instance, "RuleE", COMPLETED)

	cc.ChangeGtwState(ctx, instance, "GateE2", ENABLED)
...
func (cc *SmartContract) StartEvent_BRE(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)

	actionEvent, err := cc.ReadEvent(ctx, instanceID, "StartEvent_BRE")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "StartEvent_BRE", COMPLETED)
	stub.SetEvent("StartEvent_BRE", []byte("Contract has been started successfully"))
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "InputE", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) InputE_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "InputE")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgState(ctx, instance, "InputE", COMPLETED)

	stub.SetEvent("InputE", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) InputE_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "InputE")
	if err != nil {
	...
	stub.SetEvent("InputE", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeBusinessRuleState(ctx, instance, "RuleE", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) OutputE_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "OutputE")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "OutputE", COMPLETED)

	stub.SetEvent("OutputE", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) OutputE_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "OutputE")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("OutputE", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeEventState(ctx, instance, "EndEvent_BRE", ENABLED)

	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) GateE2(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "GateE2")
	if err != nil {
		return err
	}
	...
	stub.SetEvent("GateE2", []byte("Gateway has been completed"))
	cc.SetInstance(ctx, instance)
	if instance.InstanceStateMemory.OkE == true {
		cc.ChangeMsgState(ctx, instance, "OutputE", ENABLED)
	} else {
		cc.ChangeEventState(ctx, instance, "EndEvent_BRE", ENABLED)
	}
...
func (cc *SmartContract) EndEvent_BRE(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "EndEvent_BRE")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "EndEvent_BRE", COMPLETED)
	stub.SetEvent("EndEvent_BRE", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
