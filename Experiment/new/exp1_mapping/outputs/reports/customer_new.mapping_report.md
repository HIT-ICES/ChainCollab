# Mapping Report: customer_new

## Metrics

- Total elements: 28
- Preserved elements: 28
- Successful mappings: 28
- Contract total: 29
- Contract passed: 29
...
- BPMN: `/root/code/ChainCollab/Experiment/BPMNwithDMNcase/customer_new.bpmn`
- DMN: `/root/code/ChainCollab/Experiment/BPMNwithDMNcase/customer.dmn`
- B2C: `/root/code/ChainCollab/Experiment/new/exp1_mapping/outputs/regenerated/customer_new.generated.b2c`
...
- PASS | event_mapping | BPMN `Event_143ykco` -> DSL `Event_143ykco` | Event preserved with expected progression rule.
- PASS | businessrule_mapping | BPMN `Activity_1yl9tfp` -> DSL `Activity_1yl9tfp` | Business rule mapping preserved.
- PASS | businessrule_mapping | BPMN `Activity_0ibsbry` -> DSL `Activity_0ibsbry` | Business rule mapping preserved.
