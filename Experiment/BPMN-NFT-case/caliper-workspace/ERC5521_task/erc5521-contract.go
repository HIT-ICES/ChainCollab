...
func (c *SmartContract) Initialize(ctx contractapi.TransactionContextInterface, name string, symbol string, chaincodeName string) (bool, error) {
	...
	c.SetChaincodeName(ctx, chaincodeName)
	return true, nil
}
