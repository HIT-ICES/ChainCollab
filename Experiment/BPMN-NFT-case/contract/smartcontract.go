...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateTokenElement(ctx, &instance, "Activity_0i3c0p3", DISABLED, `{"assetType":"transferable","tokenType":"NFT","tokenName":"rawMaterial","tokenId":"1","tokenHasExistInERC":false,"operation":"mint","caller":"Participant_0wg64sj"}`, initParameters.ERCChaincodeNames["Activity_0i3c0p3"], initParameters.BpmnId)
	cc.CreateTokenElement(ctx, &instance, "Activity_11qv4ci", DISABLED, `{"assetType":"transferable","tokenType":"NFT","tokenName":"rawMaterial","tokenId":"1","tokenHasExistInERC":false,"operation":"Transfer","caller":"Participant_0wg64sj","callee":["Participant_18g06ah"]}`, initParameters.ERCChaincodeNames["Activity_11qv4ci"], initParameters.BpmnId)
