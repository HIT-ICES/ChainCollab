...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateTokenElement(ctx, &instance, "Activity_0vjedml", DISABLED, `{"assetType":"value-added","tokenName":"ai data","tokenId":"1","tokenHasExistInERC":false,"operation":"branch","caller":"Participant_1nczm69"}`, initParameters.ERCChaincodeNames["Activity_0vjedml"], initParameters.BpmnId)
	cc.CreateTokenElement(ctx, &instance, "Activity_0z4hvvs", DISABLED, `{"assetType":"value-added","tokenName":"ai data","tokenId":"2","refTokenIds":["1"],"tokenHasExistInERC":false,"operation":"branch","caller":"Participant_1ohclkv"}`, initParameters.ERCChaincodeNames["Activity_0z4hvvs"], initParameters.BpmnId)
	cc.CreateTokenElement(ctx, &instance, "Activity_1pvlgsk", DISABLED, `{"assetType":"value-added","tokenName":"ai data","tokenId":"3","refTokenIds":["1"],"tokenHasExistInERC":false,"operation":"branch","caller":"Participant_05cm9yd"}`, initParameters.ERCChaincodeNames["Activity_1pvlgsk"], initParameters.BpmnId)
	cc.CreateTokenElement(ctx, &instance, "Activity_1a1v36t", DISABLED, `{"assetType":"value-added","tokenName":"ai data","tokenId":"4","refTokenIds":["3","2"],"tokenHasExistInERC":false,"operation":"merge","caller":"Participant_0flfbxu"}`, initParameters.ERCChaincodeNames["Activity_1a1v36t"], initParameters.BpmnId)
...
func (cc *SmartContract) Activity_0vjedml_Continue(ctx contractapi.TransactionContextInterface, instanceID string) error {
