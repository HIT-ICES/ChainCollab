...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateTokenElement(ctx, &instance, "Activity_0udosg1", DISABLED, `{"assetType":"distributive","tokenName":"EBook","tokenId":"1","tokenHasExistInERC":false,"operation":"mint","caller":"Participant_19kwe8n"}`, initParameters.ERCChaincodeNames["Activity_0udosg1"], initParameters.BpmnId)
	cc.CreateTokenElement(ctx, &instance, "Activity_0ciiqug", DISABLED, `{"assetType":"distributive","tokenName":"EBook","tokenId":"1","tokenHasExistInERC":false,"operation":"grant usage rights","caller":"Participant_19kwe8n","callee":["Participant_0mcenv6"]}`, initParameters.ERCChaincodeNames["Activity_0ciiqug"], initParameters.BpmnId)
	cc.CreateTokenElement(ctx, &instance, "Activity_1nffpfx", DISABLED, `{"assetType":"distributive","tokenName":"EBook","tokenId":"1","tokenHasExistInERC":false,"operation":"revoke usage rights","caller":"Participant_19kwe8n","callee":["Participant_0mcenv6"]}`, initParameters.ERCChaincodeNames["Activity_1nffpfx"], initParameters.BpmnId)
	cc.CreateTokenElement(ctx, &instance, "Activity_013vhiy", DISABLED, `{"assetType":"distributive","tokenName":"EBook","tokenId":"1","tokenHasExistInERC":false,"operation":"transfer","caller":"Participant_19kwe8n","callee":["Participant_0mcenv6"]}`, initParameters.ERCChaincodeNames["Activity_013vhiy"], initParameters.BpmnId)
	cc.CreateTokenElement(ctx, &instance, "Activity_0jgcjkn", DISABLED, `{"assetType":"distributive","tokenName":"EBook","tokenId":"1","tokenHasExistInERC":false,"operation":"burn","caller":"Participant_19kwe8n"}`, initParameters.ERCChaincodeNames["Activity_0jgcjkn"], initParameters.BpmnId)
...
func (cc *SmartContract) Message_183xuj5_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	...
	cc.changeTokenElementState(ctx, instance, "Activity_1nffpfx", ENABLED)
	cc.SetInstance(ctx, instance)
	return nil
}
...
func (cc *SmartContract) Activity_0udosg1_Continue(ctx contractapi.TransactionContextInterface, instanceID string) error {
...
func (cc *SmartContract) Activity_1nffpfx(ctx contractapi.TransactionContextInterface, instanceID string) error {
	instance, err := cc.GetInstance(ctx, instanceID)
	if err != nil {
		return err
	}
	...
	//得到tokenElement元素
	tokenElement, err := cc.ReadTokenElement(ctx, instanceID, "Activity_1nffpfx")
	if err != nil {
		return err
	}
	//得到token元素
	...
	//改状态
	cc.changeTokenElementState(ctx, instance, "Activity_1nffpfx", COMPLETED)
	cc.SetInstance(ctx, instance)
...
func (cc *SmartContract) Activity_013vhiy(ctx contractapi.TransactionContextInterface, instanceID string) error {
	instance, err := cc.GetInstance(ctx, instanceID)
	if err != nil {
		return err
	}
...
func (cc *SmartContract) Activity_0jgcjkn(ctx contractapi.TransactionContextInterface, instanceID string) error {
	instance, err := cc.GetInstance(ctx, instanceID)
	if err != nil {
		return err
	}
