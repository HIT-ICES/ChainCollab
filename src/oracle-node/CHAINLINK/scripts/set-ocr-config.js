...
function getNodeInfo() {
    const nodeInfoFile = 'deployment/node-info.json';
...
function getOCRDeployment() {
    const ocrDeploymentFile = 'deployment/ocr-deployment.json';
...
function getOCRContractABI() {
    ...
    const compiledFile = `${deploymentDir}/compiled.json`;
...
function getGeneratedOCRConfig() {
    const configFile = 'deployment/ocr-config-gen.json';
...
async function main() {
    try {
        ...
        const configFile = 'deployment/ocr-config.json';
