...
**位置**: `/oracle-node/CHAINLINK/scripts/dmn-server-java/`
...
**位置**: `/oracle-node/CHAINLINK/config/job-spec-dmn-java.toml`
...
node scripts/set-job-id-dmn.js <externalJobId>
```
...
```bash
# 检查 DMN 服务日志
cat scripts/dmn-server-java/dmn-server.log
