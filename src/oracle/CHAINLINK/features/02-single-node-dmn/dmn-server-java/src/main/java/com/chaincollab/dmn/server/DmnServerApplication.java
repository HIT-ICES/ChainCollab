...
public class DmnServerApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("================================================");
        System.out.println("健康检查: GET http://localhost:8080/api/dmn/health");
        System.out.println("执行决策: POST http://localhost:8080/api/dmn/evaluate");
        System.out.println("缓存决策: POST http://localhost:8080/api/dmn/calc");
        System.out.println("读取缓存: GET http://localhost:8080/api/dmn/latest");
        System.out.println("确认清缓存: POST http://localhost:8080/api/dmn/ack");
