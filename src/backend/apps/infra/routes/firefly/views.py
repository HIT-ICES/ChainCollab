...
from apps.api.config import CELLO_HOME, CURRENT_IP, DEFAULT_CHANNEL_NAME
...
from apps.environment.models import EthEnvironment, Environment, Task
from apps.core.models import LoleidoOrganization, Membership
from common import ok, err

from common.lib.firefly.firefly import Firefly_cli
...
class FireflyViewSet(viewsets.ModelViewSet):
    ...
    def _init_eth_for_env(self, env_id):
        ...
        from apps.ethereum.models import EthNode
