...
from common.utils.common import with_common_response, parse_block_file, to_dict
from common.lib.configtxgen import ConfigTX, ConfigTxGen
from common.lib.peer.channel import Channel as PeerChannel
from common.lib.configtxlator.configtxlator import ConfigTxLator
from common.exceptions import ResourceNotFound, NoResource
...
from apps.fabric.routes.channel.serializers import (
    ChannelAnchorBody,
    ChannelCreateBody,
    ChannelIDSerializer,
    ChannelListResponse,
