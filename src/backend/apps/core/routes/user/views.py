...
from common.exceptions import ResourceExists, CustomError
from apps.core.models import UserProfile, LoleidoOrganization
from apps.core.routes.user.serializers import (
    UserCreateBody,
    UserIDSerializer,
    UserQuerySerializer,
    UserListSerializer,
...
class UserViewSet(viewsets.ViewSet):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            if org_id:
                try:
                    ...
                    query_params.update({"id__in": members})
    ...
    @swagger_auto_schema(
        ...
        responses=with_common_response({status.HTTP_201_CREATED: UserIDSerializer}),
    )
    def create(self, request):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            if user_count > 0:
                raise ResourceExists(detail="User name or email already exists")
