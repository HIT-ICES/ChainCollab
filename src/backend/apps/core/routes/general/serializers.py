...
from apps.core.routes.user.serializers import UserInfoSerializer
...
class RegisterResponse(serializers.Serializer):
    # Choice Success or Fail
    status = serializers.ChoiceField(
        help_text="status of register", choices=("Success", "Fail"), default="Success"
    )
