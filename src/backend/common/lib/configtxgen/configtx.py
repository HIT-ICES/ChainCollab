...
class ConfigTX:
    """Class represents config-tx yaml."""

    def __init__(self, network, filepath=CELLO_HOME, orderer=None, raft_option=None, template_path=f"{FABRIC_CONFIG}/configtx.yaml"):
        """init ConfigTX
                param:
