...
type StateMemory struct {
	Self_pickup bool `json:"Self_pickup"`
	Amount int `json:"Amount"`
	Del_order string `json:"Del_order"`
	Deliver bool `json:"Deliver"`
	Delivered_product string `json:"Delivered_product"`
	Fwd_order string `json:"Fwd_order"`
	Order string `json:"Order"`
	Placed_order string `json:"Placed_order"`
	Pre_details string `json:"Pre_details"`
	Report string `json:"Report"`
	Req_details string `json:"Req_details"`
	Transport_order string `json:"Transport_order"`
...
type InitParameters struct {
	...
	Activity_0fbi09z_DecisionID string `json:"Activity_0fbi09z_DecisionID"`
	Activity_0fbi09z_ParamMapping map[string]string `json:"Activity_0fbi09z_ParamMapping"`
	Activity_0fbi09z_Content string `json:"Activity_0fbi09z_Content"`
}
...
func (cc *SmartContract) CreateInstance(ctx contractapi.TransactionContextInterface, initParametersBytes string) (string, error) {
	...
	cc.CreateActionEvent(ctx, &instance, "Event_0eoqvir", DISABLED)
	cc.CreateMessage(ctx, &instance, "Message_04wmlqe", "Participant_19mgbdn", "Participant_0w6qkdf", "", DISABLED, `{"schema": "{\"properties\":{\"report\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0cba4t6", "Participant_0w6qkdf", "Participant_0sa2v7d", "", DISABLED, `{"schema": "{\"properties\":{\"fwd_order\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0d2xte5", "Participant_19j1e3o", "Participant_19mgbdn", "", DISABLED, `{"schema": "{\"properties\":{\"del_order\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0hpha6h", "Participant_0sa2v7d", "Participant_19j1e3o", "", DISABLED, `{"schema": "{\"properties\":{\"pre_details\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0pm90nx", "Participant_0w6qkdf", "Participant_19j1e3o", "", DISABLED, `{"schema": "{\"properties\":{\"transport_order\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0ps2yzo", "Participant_0w6qkdf", "Participant_19mgbdn", "", DISABLED, `{"schema": "{\"properties\":{\"Self_pickup\":{\"type\":\"boolean\",\"description\":\"\"}},\"required\":[\"Self_pickup\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_0rwz1km", "Participant_19j1e3o", "Participant_0sa2v7d", "", DISABLED, `{"schema": "{\"properties\":{\"req_details\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_196q1fj", "Participant_19mgbdn", "Participant_0w6qkdf", "", DISABLED, `{"schema": "{\"properties\":{\"delivered_product\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1ajdm9l", "Participant_19mgbdn", "Participant_09cjol2", "", DISABLED, `{"schema": "{\"properties\":{\"placed_order\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1io2g9u", "Participant_0sa2v7d", "Participant_19j1e3o", "", DISABLED, `{"schema": "{\"properties\":{\"waybill\":{\"type\":\"string\",\"description\":\"\"}},\"required\":[],\"files\":{},\"file required\":[]}"}`)
	cc.CreateMessage(ctx, &instance, "Message_1wswgqu", "Participant_0w6qkdf", "Participant_19mgbdn", "", DISABLED, `{"schema": "{\"properties\":{\"order\":{\"type\":\"string\",\"description\":\"\"},\"amount\":{\"type\":\"number\",\"description\":\"\"}},\"required\":[\"order\",\"amount\"],\"files\":{},\"file required\":[]}"}`)
	cc.CreateGateway(ctx, &instance, "Gateway_11hmo2k", DISABLED)
	cc.CreateGateway(ctx, &instance, "Gateway_0onpe6x", DISABLED)
	cc.CreateGateway(ctx, &instance, "Gateway_1fbifca", DISABLED)
	cc.CreateBusinessRule(ctx, &instance, "Activity_0fbi09z", initParameters.Activity_0fbi09z_Content, initParameters.Activity_0fbi09z_DecisionID, initParameters.Activity_0fbi09z_ParamMapping)
	...
	eventPayload := map[string]string{
		"InstanceID": instanceID,
		"Activity_0fbi09z": initParameters.Activity_0fbi09z_Content,
	}
...
func (cc *SmartContract) Activity_0fbi09z(ctx contractapi.TransactionContextInterface, instanceID string) error {


	instance, err := cc.GetInstance(ctx, instanceID)
	// Read Business Info
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "Activity_0fbi09z")
	if err != nil {
		return err
	}
	...
	eventPayload := map[string]string{
		"ID":        "Activity_0fbi09z",
		"InstanceID": instanceID,
		"Func":	   "Activity_0fbi09z_Continue",
		"CID": dataItem.Value, 
	}
	...
	cc.ChangeBusinessRuleState(ctx, instance, "Activity_0fbi09z", WAITINGFORCONFIRMATION)
	cc.SetInstance(ctx, instance)

	return nil
}

func (cc *SmartContract) Activity_0fbi09z_Continue(ctx contractapi.TransactionContextInterface, instanceID string, ContentOfDmn string) error {
	// Read Business Info
	instance,err:=cc.GetInstance(ctx, instanceID)
	businessRule, err := cc.ReadBusinessRule(ctx, instanceID, "Activity_0fbi09z")
	if err != nil {
	...
	cc.ChangeBusinessRuleState(ctx, instance, "Activity_0fbi09z", COMPLETED)

	cc.ChangeGtwState(ctx, instance, "Gateway_11hmo2k", ENABLED)


	cc.SetInstance(ctx, instance)
	eventPayload := map[string]string{
		"ID":         "Activity_0fbi09z_Continue",
		"InstanceID": instanceID,
	}
...
func (cc *SmartContract) Message_04wmlqe_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	...
	cc.SetInstance(ctx, instance)
	cc.ChangeMsgState(ctx, instance, "Message_0ps2yzo", ENABLED)
...
func (cc *SmartContract) Message_0ps2yzo_Send(ctx contractapi.TransactionContextInterface, instanceID string, fireflyTranID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_0ps2yzo")
	if err != nil {
		return err
	}
	...
	cc.ChangeMsgFireflyTranID(ctx, instance, fireflyTranID, msg.MessageID)
	cc.ChangeMsgState(ctx, instance, "Message_0ps2yzo", COMPLETED)

	stub.SetEvent("Message_0ps2yzo", []byte("Message is waiting for confirmation"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}

func (cc *SmartContract) Message_0ps2yzo_Complete(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	msg, err := cc.ReadMsg(ctx, instanceID, "Message_0ps2yzo")
	if err != nil {
	...
	cc.ChangeMsgState(ctx, instance, msg.MessageID, COMPLETED)
	stub.SetEvent("Message_0ps2yzo", []byte("Message has been done"))
	cc.SetInstance(ctx, instance)
	cc.ChangeBusinessRuleState(ctx, instance, "Activity_0fbi09z", ENABLED)
...
func (cc *SmartContract) Gateway_11hmo2k(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	gtw, err := cc.ReadGtw(ctx, instanceID, "Gateway_11hmo2k")
	if err != nil {
		return err
	}
	...
	cc.SetInstance(ctx, instance)
	if instance.InstanceStateMemory.Deliver == true {
		cc.ChangeMsgState(ctx, instance, "Message_196q1fj", ENABLED)
	} else if instance.InstanceStateMemory.Deliver == false {
		cc.ChangeEventState(ctx, instance, "Event_0eoqvir", ENABLED)
	}
...
func (cc *SmartContract) Event_0eoqvir(ctx contractapi.TransactionContextInterface, instanceID string) error {
	stub := ctx.GetStub()
	instance, err := cc.GetInstance(ctx, instanceID)
	actionEvent, err := cc.ReadEvent(ctx, instanceID, "Event_0eoqvir")
	if err != nil {
		return err
	}
	...
	cc.ChangeEventState(ctx, instance, "Event_0eoqvir", COMPLETED)
	stub.SetEvent("Event_0eoqvir", []byte("Event has been completed"))
	cc.SetInstance(ctx, instance)
	cc.SetInstance(ctx, instance)
	return nil
}
